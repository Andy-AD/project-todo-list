...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    font-size: 16px;\n    font-family: monospace;\n    --light-color: white;\n    --corner-radius: 10px;\n    --box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n    --text-color: black;\n    --main-color: lightblue;\n    --secondary-color: lightgreen;   \n    --button-hover-color: yellow;\n    --close-button-distance: 5px;\n    --delete-task-button: red;\n    --delete-task-button-text: white;\n}\n\nbody {\n    min-height: 100vh;\n    width: 100vw;\n    display: flex;\n    flex-direction: column;\n}\n\nheader {\n    height: 80px;\n    width: 100%;\n    border-bottom: 1px solid black;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\nheader>h1 {\n    display: flex;\n    align-items: center;\n    grid-area: 1 / 1 / -1 / -1;\n    font-size: 2.5rem;\n    padding: 10px 50px;\n}\n\n.logo {\n    font-size: 2.5rem;\n    color: green;\n}\n\n.menu-icon {\n    grid-area: 1 / 1 / -1 / 2;\n}\n\n.menu-icon:hover {\n    cursor: pointer;\n}\n\n.menu-icon>div {\n    width: 35px;\n    height: 5px;\n    background-color: black;\n    margin: 6px 0;\n}\n\nmain {\n    flex-grow: 1;\n    display: grid;\n    grid-template-columns: 300px 1fr;\n    grid-template-rows: 60px 1fr;\n}\n\n.sidebar {\n    grid-area: 1 / 1 / -1 / 2;\n    border-right: 1px solid black;\n    background-color: var(--main-color);\n}\n\n.sidebar>div {\n    width: 100%;\n    padding: 20px;\n}\n\n.sidebar h2 {\n    font-size: 1.8em;\n    border-bottom: 1px solid black;\n}\n\n\n\n.sidebar li {\n    \n    border: 1px solid black;\n    font-size: 1.5em;\n    width: 90%;\n    border-radius: var(--corner-radius);\n    margin: 10px 20px;\n    padding: 5px 5px 5px 14px;\n    user-select: none;\n}\n\n.sidebar li:hover {\n    cursor: pointer;\n    background-color: var(--button-hover-color);\n    box-shadow: var(--box-shadow);\n}\n\n.view-tasks {\n    background-color: var(--light-color);\n}\n\n.project {\n    background-color: var(--light-color);\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border: 1px solid black;\n}\n\n.active {\n    background-color: var(--secondary-color);\n    color: black;\n}\n\n.delete-icon {\n    color: red;\n}\n\n.delete-icon:hover {\n    color:black;\n    background-color: var(--button-hover-color);\n}\n\n.add-task-bar {\n    grid-area: 1 / 2 / 2 / -1;\n    display: flex;\n    justify-content: flex-end;\n    align-items: center;\n    padding-left: 20px;\n}\n\n.add-task-bar button {\n    background-color: var(--secondary-color);\n    width: auto;\n    font-size: 1.4em;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    padding: 5px 10px;\n    margin-right: 20px;\n    border-radius: var(--corner-radius);\n    cursor: pointer;\n    outline: none;\n}\n\n.add-task-bar button:hover {\n    background-color: yellow;\n    box-shadow: var(--box-shadow);\n}\n\n.task-container {\n    grid-area: 2 / 2 / -1 / -1;\n    display: flex;\n    flex-direction: column;\n    justify-content: start;\n    align-items: center;\n}\n\n.task {\n    width: 80%;\n    display: flex;\n    flex-direction: column;\n    margin: 10px 0;\n    border: 1px solid black;\n    border-radius: var(--corner-radius);\n    background-color: whitesmoke;\n}\n\n.task:hover, \n.project:hover {\n    box-shadow: var(--box-shadow);\n}\n\n.main {\n    border-radius: var(--corner-radius);\n    color: black;\n    width: 100%;\n    display: grid;\n    grid-template-columns: auto 1fr auto auto auto auto;\n    gap: 10px;\n    grid-template-rows: auto;\n    align-items: center;\n    cursor: pointer;\n    padding: 5px;\n}\n\n.complete-task-checkbox {\n    margin: 0 20px;\n    height: 1.2rem;\n    width: 1.2rem;\n}\n\n\n.main>h3 {\n    font-size: 1.4rem;\n    font-weight: 500;\n}\n\n.main>span {\n    font-size: 1.4rem;\n}\n\n.main>button {\n    padding: 5px 10px;\n    border-radius: var(--corner-radius);\n    font-size: 1.2rem;\n}\n\n.open-details-button {\n    background-color: lightblue;\n}\n\n.delete-task-button {\n    color: var(--delete-task-button-text);\n    background-color: var(--delete-task-button);\n}\n\n.edit-task-button:disabled:hover {\n    box-shadow: none;\n}\n\n\n.main> button:hover {\n    box-shadow: var(--box-shadow);\n}\n\n.delete-task-button:hover {\n    color: var(--delete-task-button);\n    background-color: var(--delete-task-button-text);\n    border: 2px solid var(--delete-task-button);\n}\n\n\n.details {\n    display: none;\n    padding: 20px;\n    overflow: hidden;\n    border-top: 1px solid black;\n    background-color: white;\n    border-radius: 0 0 var(--corner-radius) var(--corner-radius);\n}\n\n.details>div {\n    font-size: 1.2rem;\n}\n\n.priority-low {\n    border-left: 5px solid green;\n}\n\n.priority-medium {\n    border-left: 5px solid orange;\n}\n\n.priority-high {\n    border-left: 5px solid red;\n}\n\nfooter {\n    height: 60px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.modal-task,\n.modal-project {\n    display: none;\n    position: fixed;\n    justify-content: center;\n    align-items: center;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    background-color: rgba(0, 0, 0, 0.4);\n}\n\n.add-task,\n.add-project {\n    position: relative;\n    height: auto;\n    width: 60%;\n    border-radius: var(--corner-radius);\n    border: 2px var(--main-color) solid;\n    background-color: white;\n    padding: 10px;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n}\n\n#create-task {\n    display: flex;\n    flex-direction: column;\n}\n\n.add-task h2,\n.add-project h2 {\n    font-size: 2em;\n    align-self: center;\n    padding: 5px 0 20px 0;\n}\n\n.add-task label {\n    font-size: 1.2em;\n    margin: 10px 0 5px 0;\n    font-weight: 600;\n}\n\n.add-task input,\n.add-task select,\n.add-task textarea,\n.add-project input {\n    padding: 5px 10px;\n    font-size: 1.2em;\n    border-radius: var(--corner-radius);\n}\n\n.add-task button,\n.add-project button {\n    width: 200px;\n    margin: 10px auto;\n    padding: 5px;\n    border-radius: var(--corner-radius);\n    outline: none;\n    background-color: lightgreen;\n    font-size: 1.2em;\n    cursor: pointer;\n}\n\n.add-task button:hover,\n.add-project button:hover {\n    background-color: var(--button-hover-color);\n    box-shadow: var(--box-shadow);\n}\n\n.add-project>form {\n    display: flex;\n    flex-direction: column;\n}\n\n.close {\n    color: #6e6c6c;\n    font-size: 40px;\n    font-weight: bold;\n    position: absolute;\n    right: var(--close-button-distance);\n    top: var(--close-button-distance);\n    cursor: pointer;\n}\n\n.close:hover {\n    color: var(--text-color);\n}\n\n.details-visible {\n    display: flex;\n}\n\n.completed-date {\n    color: green;\n}\n\n.completed-crossed-out {\n    text-decoration: line-through;\n}\n\nfooter {\n    border-top: 1px solid black;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;IACtB,eAAe;IACf,sBAAsB;IACtB,oBAAoB;IACpB,qBAAqB;IACrB,6CAA6C;IAC7C,mBAAmB;IACnB,uBAAuB;IACvB,6BAA6B;IAC7B,4BAA4B;IAC5B,4BAA4B;IAC5B,yBAAyB;IACzB,gCAAgC;AACpC;;AAEA;IACI,iBAAiB;IACjB,YAAY;IACZ,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,8BAA8B;IAC9B,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,0BAA0B;IAC1B,iBAAiB;IACjB,kBAAkB;AACtB;;AAEA;IACI,iBAAiB;IACjB,YAAY;AAChB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,WAAW;IACX,WAAW;IACX,uBAAuB;IACvB,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,gCAAgC;IAChC,4BAA4B;AAChC;;AAEA;IACI,yBAAyB;IACzB,6BAA6B;IAC7B,mCAAmC;AACvC;;AAEA;IACI,WAAW;IACX,aAAa;AACjB;;AAEA;IACI,gBAAgB;IAChB,8BAA8B;AAClC;;;;AAIA;;IAEI,uBAAuB;IACvB,gBAAgB;IAChB,UAAU;IACV,mCAAmC;IACnC,iBAAiB;IACjB,yBAAyB;IACzB,iBAAiB;AACrB;;AAEA;IACI,eAAe;IACf,2CAA2C;IAC3C,6BAA6B;AACjC;;AAEA;IACI,oCAAoC;AACxC;;AAEA;IACI,oCAAoC;IACpC,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,wCAAwC;IACxC,YAAY;AAChB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,WAAW;IACX,2CAA2C;AAC/C;;AAEA;IACI,yBAAyB;IACzB,aAAa;IACb,yBAAyB;IACzB,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,wCAAwC;IACxC,WAAW;IACX,gBAAgB;IAChB,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,iBAAiB;IACjB,kBAAkB;IAClB,mCAAmC;IACnC,eAAe;IACf,aAAa;AACjB;;AAEA;IACI,wBAAwB;IACxB,6BAA6B;AACjC;;AAEA;IACI,0BAA0B;IAC1B,aAAa;IACb,sBAAsB;IACtB,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,UAAU;IACV,aAAa;IACb,sBAAsB;IACtB,cAAc;IACd,uBAAuB;IACvB,mCAAmC;IACnC,4BAA4B;AAChC;;AAEA;;IAEI,6BAA6B;AACjC;;AAEA;IACI,mCAAmC;IACnC,YAAY;IACZ,WAAW;IACX,aAAa;IACb,mDAAmD;IACnD,SAAS;IACT,wBAAwB;IACxB,mBAAmB;IACnB,eAAe;IACf,YAAY;AAChB;;AAEA;IACI,cAAc;IACd,cAAc;IACd,aAAa;AACjB;;;AAGA;IACI,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;IACjB,mCAAmC;IACnC,iBAAiB;AACrB;;AAEA;IACI,2BAA2B;AAC/B;;AAEA;IACI,qCAAqC;IACrC,2CAA2C;AAC/C;;AAEA;IACI,gBAAgB;AACpB;;;AAGA;IACI,6BAA6B;AACjC;;AAEA;IACI,gCAAgC;IAChC,gDAAgD;IAChD,2CAA2C;AAC/C;;;AAGA;IACI,aAAa;IACb,aAAa;IACb,gBAAgB;IAChB,2BAA2B;IAC3B,uBAAuB;IACvB,4DAA4D;AAChE;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,4BAA4B;AAChC;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,0BAA0B;AAC9B;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;;IAEI,aAAa;IACb,eAAe;IACf,uBAAuB;IACvB,mBAAmB;IACnB,UAAU;IACV,OAAO;IACP,MAAM;IACN,WAAW;IACX,YAAY;IACZ,cAAc;IACd,oCAAoC;AACxC;;AAEA;;IAEI,kBAAkB;IAClB,YAAY;IACZ,UAAU;IACV,mCAAmC;IACnC,mCAAmC;IACnC,uBAAuB;IACvB,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B;;AAEA;;IAEI,cAAc;IACd,kBAAkB;IAClB,qBAAqB;AACzB;;AAEA;IACI,gBAAgB;IAChB,oBAAoB;IACpB,gBAAgB;AACpB;;AAEA;;;;IAII,iBAAiB;IACjB,gBAAgB;IAChB,mCAAmC;AACvC;;AAEA;;IAEI,YAAY;IACZ,iBAAiB;IACjB,YAAY;IACZ,mCAAmC;IACnC,aAAa;IACb,4BAA4B;IAC5B,gBAAgB;IAChB,eAAe;AACnB;;AAEA;;IAEI,2CAA2C;IAC3C,6BAA6B;AACjC;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,cAAc;IACd,eAAe;IACf,iBAAiB;IACjB,kBAAkB;IAClB,mCAAmC;IACnC,iCAAiC;IACjC,eAAe;AACnB;;AAEA;IACI,wBAAwB;AAC5B;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,2BAA2B;AAC/B","sourcesContent":["* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    font-size: 16px;\n    font-family: monospace;\n    --light-color: white;\n    --corner-radius: 10px;\n    --box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;\n    --text-color: black;\n    --main-color: lightblue;\n    --secondary-color: lightgreen;   \n    --button-hover-color: yellow;\n    --close-button-distance: 5px;\n    --delete-task-button: red;\n    --delete-task-button-text: white;\n}\n\nbody {\n    min-height: 100vh;\n    width: 100vw;\n    display: flex;\n    flex-direction: column;\n}\n\nheader {\n    height: 80px;\n    width: 100%;\n    border-bottom: 1px solid black;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\nheader>h1 {\n    display: flex;\n    align-items: center;\n    grid-area: 1 / 1 / -1 / -1;\n    font-size: 2.5rem;\n    padding: 10px 50px;\n}\n\n.logo {\n    font-size: 2.5rem;\n    color: green;\n}\n\n.menu-icon {\n    grid-area: 1 / 1 / -1 / 2;\n}\n\n.menu-icon:hover {\n    cursor: pointer;\n}\n\n.menu-icon>div {\n    width: 35px;\n    height: 5px;\n    background-color: black;\n    margin: 6px 0;\n}\n\nmain {\n    flex-grow: 1;\n    display: grid;\n    grid-template-columns: 300px 1fr;\n    grid-template-rows: 60px 1fr;\n}\n\n.sidebar {\n    grid-area: 1 / 1 / -1 / 2;\n    border-right: 1px solid black;\n    background-color: var(--main-color);\n}\n\n.sidebar>div {\n    width: 100%;\n    padding: 20px;\n}\n\n.sidebar h2 {\n    font-size: 1.8em;\n    border-bottom: 1px solid black;\n}\n\n\n\n.sidebar li {\n    \n    border: 1px solid black;\n    font-size: 1.5em;\n    width: 90%;\n    border-radius: var(--corner-radius);\n    margin: 10px 20px;\n    padding: 5px 5px 5px 14px;\n    user-select: none;\n}\n\n.sidebar li:hover {\n    cursor: pointer;\n    background-color: var(--button-hover-color);\n    box-shadow: var(--box-shadow);\n}\n\n.view-tasks {\n    background-color: var(--light-color);\n}\n\n.project {\n    background-color: var(--light-color);\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border: 1px solid black;\n}\n\n.active {\n    background-color: var(--secondary-color);\n    color: black;\n}\n\n.delete-icon {\n    color: red;\n}\n\n.delete-icon:hover {\n    color:black;\n    background-color: var(--button-hover-color);\n}\n\n.add-task-bar {\n    grid-area: 1 / 2 / 2 / -1;\n    display: flex;\n    justify-content: flex-end;\n    align-items: center;\n    padding-left: 20px;\n}\n\n.add-task-bar button {\n    background-color: var(--secondary-color);\n    width: auto;\n    font-size: 1.4em;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    padding: 5px 10px;\n    margin-right: 20px;\n    border-radius: var(--corner-radius);\n    cursor: pointer;\n    outline: none;\n}\n\n.add-task-bar button:hover {\n    background-color: yellow;\n    box-shadow: var(--box-shadow);\n}\n\n.task-container {\n    grid-area: 2 / 2 / -1 / -1;\n    display: flex;\n    flex-direction: column;\n    justify-content: start;\n    align-items: center;\n}\n\n.task {\n    width: 80%;\n    display: flex;\n    flex-direction: column;\n    margin: 10px 0;\n    border: 1px solid black;\n    border-radius: var(--corner-radius);\n    background-color: whitesmoke;\n}\n\n.task:hover, \n.project:hover {\n    box-shadow: var(--box-shadow);\n}\n\n.main {\n    border-radius: var(--corner-radius);\n    color: black;\n    width: 100%;\n    display: grid;\n    grid-template-columns: auto 1fr auto auto auto auto;\n    gap: 10px;\n    grid-template-rows: auto;\n    align-items: center;\n    cursor: pointer;\n    padding: 5px;\n}\n\n.complete-task-checkbox {\n    margin: 0 20px;\n    height: 1.2rem;\n    width: 1.2rem;\n}\n\n\n.main>h3 {\n    font-size: 1.4rem;\n    font-weight: 500;\n}\n\n.main>span {\n    font-size: 1.4rem;\n}\n\n.main>button {\n    padding: 5px 10px;\n    border-radius: var(--corner-radius);\n    font-size: 1.2rem;\n}\n\n.open-details-button {\n    background-color: lightblue;\n}\n\n.delete-task-button {\n    color: var(--delete-task-button-text);\n    background-color: var(--delete-task-button);\n}\n\n.edit-task-button:disabled:hover {\n    box-shadow: none;\n}\n\n\n.main> button:hover {\n    box-shadow: var(--box-shadow);\n}\n\n.delete-task-button:hover {\n    color: var(--delete-task-button);\n    background-color: var(--delete-task-button-text);\n    border: 2px solid var(--delete-task-button);\n}\n\n\n.details {\n    display: none;\n    padding: 20px;\n    overflow: hidden;\n    border-top: 1px solid black;\n    background-color: white;\n    border-radius: 0 0 var(--corner-radius) var(--corner-radius);\n}\n\n.details>div {\n    font-size: 1.2rem;\n}\n\n.priority-low {\n    border-left: 5px solid green;\n}\n\n.priority-medium {\n    border-left: 5px solid orange;\n}\n\n.priority-high {\n    border-left: 5px solid red;\n}\n\nfooter {\n    height: 60px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.modal-task,\n.modal-project {\n    display: none;\n    position: fixed;\n    justify-content: center;\n    align-items: center;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    background-color: rgba(0, 0, 0, 0.4);\n}\n\n.add-task,\n.add-project {\n    position: relative;\n    height: auto;\n    width: 60%;\n    border-radius: var(--corner-radius);\n    border: 2px var(--main-color) solid;\n    background-color: white;\n    padding: 10px;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n}\n\n#create-task {\n    display: flex;\n    flex-direction: column;\n}\n\n.add-task h2,\n.add-project h2 {\n    font-size: 2em;\n    align-self: center;\n    padding: 5px 0 20px 0;\n}\n\n.add-task label {\n    font-size: 1.2em;\n    margin: 10px 0 5px 0;\n    font-weight: 600;\n}\n\n.add-task input,\n.add-task select,\n.add-task textarea,\n.add-project input {\n    padding: 5px 10px;\n    font-size: 1.2em;\n    border-radius: var(--corner-radius);\n}\n\n.add-task button,\n.add-project button {\n    width: 200px;\n    margin: 10px auto;\n    padding: 5px;\n    border-radius: var(--corner-radius);\n    outline: none;\n    background-color: lightgreen;\n    font-size: 1.2em;\n    cursor: pointer;\n}\n\n.add-task button:hover,\n.add-project button:hover {\n    background-color: var(--button-hover-color);\n    box-shadow: var(--box-shadow);\n}\n\n.add-project>form {\n    display: flex;\n    flex-direction: column;\n}\n\n.close {\n    color: #6e6c6c;\n    font-size: 40px;\n    font-weight: bold;\n    position: absolute;\n    right: var(--close-button-distance);\n    top: var(--close-button-distance);\n    cursor: pointer;\n}\n\n.close:hover {\n    color: var(--text-color);\n}\n\n.details-visible {\n    display: flex;\n}\n\n.completed-date {\n    color: green;\n}\n\n.completed-crossed-out {\n    text-decoration: line-through;\n}\n\nfooter {\n    border-top: 1px solid black;\n}"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "closeAndClearModalForProject": () => (/* binding */ closeAndClearModalForProject),
/* harmony export */   "closeAndClearModalForTask": () => (/* binding */ closeAndClearModalForTask),
/* harmony export */   "displayProjects": () => (/* binding */ displayProjects),
/* harmony export */   "displayTasks": () => (/* binding */ displayTasks),
/* harmony export */   "loadOnStart": () => (/* binding */ loadOnStart),
/* harmony export */   "showAndHideDetails": () => (/* binding */ showAndHideDetails),
/* harmony export */   "showModalForEditTask": () => (/* binding */ showModalForEditTask),
/* harmony export */   "showModalForProject": () => (/* binding */ showModalForProject),
/* harmony export */   "showModalForTask": () => (/* binding */ showModalForTask),
...
/* harmony export */   "getOneTask": () => (/* binding */ getOneTask),
/* harmony export */   "getProjects": () => (/* binding */ getProjects),
/* harmony export */   "getTasks": () => (/* binding */ getTasks),
/* harmony export */   "undoCompleteTask": () => (/* binding */ undoCompleteTask),
...
function getTasks(view, project) {
    ...
    if (view === 'today') {
        let dateToday = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'yyyy-MM-dd');
        let tasksToday = taskList.filter(task => task.dueDate === dateToday);
        return tasksToday;
    }
    if (view === 'week') {
        let tasksForWeek = taskList.filter(task => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), new Date(task.dueDate)));
        return tasksForWeek;
    }
    if (view === 'project') {
...
function completeTask(id) {
    ...
    taskList[taskIndex].completedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'yyyy-MM-dd');
    onChange();
}
...
function todoApp() {
    _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.loadOnStart();
    let currentView = 'all';
    ...
    newTaskButton.addEventListener('click', _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.showModalForTask);
    closeTaskModal.addEventListener('click', _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.closeAndClearModalForTask);
    newProjectButton.addEventListener('click', _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.showModalForProject);
    closeProjectModal.addEventListener('click', _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.closeAndClearModalForProject);
    ...
    function onUpdate() {   
        let projects = _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.getProjects();
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.displayProjects(projects, currentProject);
        let tasks = _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.getTasks(currentView, currentProject);
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.displayTasks(tasks);
    ...
    function submitTaskFormHandler(e) {
        ...
        if (e.target.dataset.id) {
            ...
            _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.updateTask(id, { title, dueDate, priority, description,projectName});
        } else {
            _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.addTask(title, dueDate, priority, description, projectName);
        }
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.closeAndClearModalForTask();
        onUpdate();
    }
    ...
    function createProject(e) {
        ...
        _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.addProject(projectName);
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.closeAndClearModalForProject();
        onUpdate();
    }
    ...
    function deleteProjectHandler(e) {
        ...
        _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.deleteProject(projectToDelete);
        currentView = 'all';
        currentProject = null;
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.toggleActiveClass();
        onUpdate();
    }

    function showDetailsButtonHandler(e) {
        let id = e.composedPath()[2].id;
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.showAndHideDetails(id);
    }

    function deleteTaskButtonHandler(e) {
        let id = e.composedPath()[2].id;
        _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.deleteTask(id);
        onUpdate();
    }

    function editTaskButtonHandler(e) {
        let id = e.composedPath()[2].id;
        let task = _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.getOneTask(id);
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.showModalForEditTask(task);
    }

    function completeTaskCheckboxHandler(e) {
        const id = e.composedPath()[2].id;
        if (e.target.checked) {
            _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.completeTask(id);
        } else {
            _modules_todoList__WEBPACK_IMPORTED_MODULE_1__.undoCompleteTask(id);
        }
        onUpdate();
    }
    ...
    function viewTasksHandler(e) {
        ...
        currentProject = null;
        _modules_displayController__WEBPACK_IMPORTED_MODULE_2__.toggleActiveClass(this);
        onUpdate();
    }
